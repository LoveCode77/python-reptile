...
url = 'https://www.bilibili.com/video/BV1DZ421N7gZ'
...
video_title = 'file/' + title + '.mp4'
audio_title = 'file/' + title + '.mp3'
merge_title = 'file/' + title + '_merge.mp4'
...
audio = AudioFileClip(audio_title)

final = video.set_audio(audio)

final.write_videofile(merge_title)
